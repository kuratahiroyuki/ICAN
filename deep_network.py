...
class CrossAttention(nn.Module):
    def __init__(self, model_params, feature_size = 384, n_heads = 4, d_dim = 32*4, feature = 128, pooling_dropout = 0.5, linear_dropout = 0.3): # original d_dim = 32
        super(CrossAttention, self).__init__()

        self.max_d = model_params['max_drug_seq']
        self.max_p = model_params['max_protein_seq']
        self.emb_size = model_params['emb_size']
        self.dropout_rate = model_params['dropout_rate'] 
        self.input_dim_drug = model_params['input_dim_drug']
        self.input_dim_target = model_params['input_dim_target']
        ...
        self.CNN = CNN(feature_size, self.max_p)
